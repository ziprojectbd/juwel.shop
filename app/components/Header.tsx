...
export default function Header({
  ...
  return (
    <header className="bg-white/90 dark:bg-gray-800/90 backdrop-blur shadow-sm sticky top-0 z-50">
        ...
        <div className="flex justify-between items-center min-h-14 sm:min-h-16 py-2">
          <div className="flex items-center space-x-2 sm:space-x-3 flex-1 min-w-0">
            ...
            <div className="min-w-0 flex-1">
              <h1 className="text-sm sm:text-lg md:text-2xl font-extrabold leading-tight whitespace-nowrap sm:whitespace-normal break-words">
          ...
          <div className="relative flex items-center gap-1.5 sm:gap-2 shrink-0 ml-2">
            ...
            {menuOpen && (
              <div
                ref={menuRef}
                className="absolute right-0 top-12 w-56 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl shadow-xl overflow-hidden z-50"
              >
